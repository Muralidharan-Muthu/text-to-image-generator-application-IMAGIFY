...
const Header = () => {
    return (
        <div className='flex flex-col items-center justify-center text-center my-20'>
            ...
            <p className='text-center text-stone-700 max-w-xl mx-auto mt-5'>Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen.</p>
            ...
            <p className='mt-2 text-neutral-600 text-sm sm:text-md'>Generated images from imagify</p>
        </div>
    )
}
